...
public enum ProcTools {
    ...
    private static func makeEntry(_ info: kinfo_proc) -> Entry {
        ...
        return Entry(pid: info.kp_proc.p_pid, ppid: info.kp_eproc.e_ppid, comm: comm, tty: tty)
    }
    ...
    private static func isAgentBundle(_ app: String) -> Bool {
        ...
        return name == "claude.app" || name == "agentwatch.app"
    }
    ...
    static func defaultAppPath(forKind kind: String) -> String? {
